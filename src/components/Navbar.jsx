...
const Navbar = () => {
  ...
  return (
    <nav
      id="home"
      className={`w-full font-poppins sticky top-0 z-100 md:px-[80px] px-[10px] py-3 flex justify-between items-center navbar ${
        isScrolled
          ? "bg-white shadow-sm z-100 border-2 h-[80px]"
          : "bg-transparent"
      }`}
    >
      <img
        src={logo}
        alt="kravy"
        className="w-[50px] bg-primary m-2 text-white p-2 rounded-xl h-[50px]"
      />{" "}
      ...
      <button className="text-white p-0.5 text-[10px] ml-[10px] bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-2xl border-2 ">
        <div className="flex bg-black justify-center items-center px-[10px] py-1 font-poppins rounded-2xl">
          ...
          By MagicScale 🚀
          {/* <FaArrowRightToBracket className="ml-[5px]"/> */}
        </div>
      </button>
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        ...
        <img
          ...
          alt="menu"
          className="w-[28px] ml-[10px] h-[28px] text-red-500 object-contain"
