...
const Support = () => {
  ...
  return (
    <div className="h-[90vh] bg-[#EEF0FA] shadow-lg bg-pattern2  flex justify-center items-center w-full">
      ...
      <div className="flex justify-center items-center w-full">
        <div
          ...
          tabindex="-1"
          aria-hidden="true"
          class="justify-center items-center  max-h-full"
        >
          <div class="p-4 w-full min-w-[350px] max-h-full">
